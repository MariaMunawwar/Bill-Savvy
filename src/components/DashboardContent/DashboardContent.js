...
function Dashboard() {
  ...
  const cardData = userData ? [
    { color: '#CDD583', icon: <KingBed />, title: 'No of Bedrooms', data: 8 },
    
    { color: '#E1EEC7', icon: <AcUnit />, title: 'Availability of AC', data: 'Yes'},
    { color: '#F8F8F8', icon: <Tv />, title: 'Availability of Television', data: 'No' },
    { color: '#F3B140', icon: <WbIncandescent />, title: 'No of Ceiling Fans', data: 10},
    { color: '#CDD583', icon: <EnergySavingsLeaf />, title: 'Energy Efficient Appliances', data: 'No'},
    { color: '#E1EEC7', icon: <WbSunny />, title: 'Renewable Energy Sources', data: 'No'},
    { color: '#F8F8F8', icon: <LocalLaundryService />, title: 'Use of Washing Machine', data: 'More than 10' },
    { color: '#F3B140', icon: <DevicesOther />, title: 'No of Electronic Devices', data: 'More than 5' },
  ] : [];
